    ...
    cells.push(
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className={clsx('text-[11px] font-semibold truncate', isSelected ? 'text-[var(--teal-text)]' : 'text-[var(--text)]')}>
            {goal.title}
          </p>
          {total > 0 && (
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-[9px] text-[var(--text-3)] flex-shrink-0">{done}/{total}</span>
            </div>
          )}
        </div>
      </button>
