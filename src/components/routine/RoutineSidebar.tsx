    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white border border-[var(--border)] rounded-[16px] p-4">
        ...
        {goalLabel && goalRoutines.length > 0 && (
          <div className="mb-2 px-2 py-1 rounded-[6px] bg-[var(--purple-bg)] text-[10px] font-medium text-[var(--purple-text)] truncate">
            {goalLabel}
          </div>
        )}
          ...
          activeRoutines.map(r => {
            ...
            return (
              <div key={r.id} className="flex items-center gap-2 py-1.5">
                ...
                {streak > 0 && (
                  <span className="text-[10px] text-[var(--teal)] font-semibold flex-shrink-0">
                    {streak}일
                  </span>
                )}
              </div>
        ...
        <div className="mt-3 flex justify-end">
          <button
            ...
            className="text-[11px] text-[var(--text-3)] hover:text-[var(--text-2)] px-2 py-1 rounded-[6px] hover:bg-[var(--surface-2)] transition-all"
          >
            관리 {showManage ? '▲' : '▼'}
          </button>
        </div>
        ...
        {showManage && (
          <div className="mt-3 pt-3 border-t border-[var(--border)]">
            ...
            {activeAll.length > 0 && (
              <div className="mb-2">
                <p className="text-[10px] text-[var(--text-3)] mb-1 flex items-center gap-1">
            ...
            {pausedAll.length > 0 && (
              <div className="mb-2">
                <p className="text-[10px] text-[var(--text-3)] mb-1">⏸ 일시정지</p>
            ...
            {archivedAll.length > 0 && (
              <div className="mb-2">
                <p className="text-[10px] text-[var(--text-3)] mb-1">▣ 보관</p>
            ...
            return (
              <div key={r.id}>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[10px] text-[var(--text-3)]">{cnt}일</span>
                </div>
                <div className="flex gap-0.5">
                  {historyDays.map(d => {
